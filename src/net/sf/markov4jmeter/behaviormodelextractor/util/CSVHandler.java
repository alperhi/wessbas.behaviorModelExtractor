...
public class CSVHandler {
	...
	/**
	 * Type constant for Windows-specific newline patterns (<code>"\r\n"</code>
	 * ).
	 */
	public final static int LINEBREAK_TYPE_WINDOWS = 0;

	/**
	 * Type constant for Unix-specific newline patterns (<code>"\n"</code>).
	 */
	public final static int LINEBREAK_TYPE_UNIX = 1;

	/**
	 * Type constant for MacOS-specific newline patterns (<code>"\r"</code>).
	 */
	 ...
	 * pattern (<code>"\r\n"</code>).
	 */
	protected final static int DEFAULT_LINEBREAK_TYPE = CSVHandler.LINEBREAK_TYPE_WINDOWS;
	 ...
	 * 
	 * @return a valid <code>String</code> instance which denotes the used
	 *         separator.
	 */
	 ...
	 * 
	 * @return one of the <code>LINEBREAK_TYPE</code> constants defined in class
	 *         {@link CSVHandler}.
	 */
	 ...
	 * 
	 * @return the values which have been read, as an array of lines; each line
	...
	public String[][] readValues(final String filename)
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				final String[] tokens = (this.separator == null) ? new String[] { line }
	...
	private String joinValuesToSingleLine(final String[] values) {
		...
		final String lineBreakPattern = this
				.getLineBreakPattern(this.lineBreakType);
	 ...
	 * 
	 * @param lineBreakType
	 *            one of the <code>LINEBREAK_TYPE</code> constants defined in
	 *            class {@link CSVHandler}.
	 * 
	 * @return The OS-related newline pattern for the given type.
	 */
