...
import net.sf.markov4jmeter.behavior.util.BehaviorResourceFactoryImpl;
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new BehaviorResourceFactoryImpl());
		...
		if (args.length == 0) {
			...
			try {
				...
				UseCase root = BehaviorFactory.eINSTANCE.createUseCase();
